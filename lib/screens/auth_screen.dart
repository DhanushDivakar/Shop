...
//         _authMode = AuthMode.Signup;
//       });
//       _controller.forward(); //this plays the animation
//     } else {
//       setState(() {
//         _authMode = AuthMode.Login;
//       });
...
// //                       transform: Matrix4.rotationZ(-8 * pi / 180)
// //                         ..translate(-10.0),
// //                       //this returns what the previous statemnets returns
// //                       // ..translate(-10.0),
// //                       decoration: BoxDecoration(
// //                         borderRadius: BorderRadius.circular(20),
// //                         color: Colors.deepOrange.shade900,
...
// //       }
// //     } on HttpException catch (error) {
// //       //on filters catch error
// //       var errorMessage = 'Authentication failed';
// //       if (error.toString().contains("EMAIL_EXISTS")) {
// //         errorMessage = 'This email address is already in use';
// //       } else if (errorMessage.toString().contains("INVALID_EMAIL")) {
// //         errorMessage = 'This is not a valid email';
// //       } else if (error.toString().contains('WEAK_PASSW0RD')) {
// //         errorMessage = 'This password is too weak';
// //       } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
